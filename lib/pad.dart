            ...
            child: RoundIconButton(
              ...
              onPressed: () {
                ...
                Navigator.of(context).push(
                  MaterialPageRoute(
                    builder: (context) => Results(result: calc.getResult(), value: calc.getValue(), description: calc.getDescription()),
                  ),
                );
              },
              buttonHeight: 50,
...
class Results extends StatelessWidget {
  Results({required this.result, required this.value, required this.description});
